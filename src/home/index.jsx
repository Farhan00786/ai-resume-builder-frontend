...
function Home() {
  ...
  return (
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        <a href="https://farhan00786.github.io/farhan-Portfolio/" className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
            <span className="text-xs bg-primary rounded-full text-white px-4 py-1.5 mr-3">Unveil</span> <span className="text-sm font-medium">The True Sense of Resume</span> 
  ...
  <svg viewBox="0 0 1200 100" width="1200" height="100" xmlns="http://www.w3.org/2000/svg">
    <g id="logoGroup">
      ...
      <image
        ...
        alt="Microsoft"
        style={{ filter: 'invert(0) grayscale(100%) contrast(100%)' }}
      />
      <image
        x="1620"
        y="20"
...
<div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
      ...
      >
        ...
        <h2 className="mt-1 text-xl font-bold text-black">Kunal Kumar Dey</h2>
    ...
    <line x1="100" y1="25" x2="10" y2="25" stroke="rgb(219 39 119 / var(--tw-bg-opacity))" strokeWidth="3">
      ...
      >
        ...
        <h2 className="mt-1 text-xl font-bold text-black">Anshika Shrivastava </h2>
    ...
    <line x1="100" y1="25" x2="10" y2="25" stroke="rgb(219 39 119 / var(--tw-bg-opacity))" strokeWidth="3">
      ...
      >
        ...
        <h2 className="mt-1 text-xl font-bold text-black">Jitendra Singh</h2>
  ...
  <footer className="bg-gray-800 text-white text-center py-4 mt-8">
      <div className="container mx-auto">
        ...
        <p>
          Designed with <span role="img" aria-label="heart" className="text-red-500">❤️</span> by Us
        </p>
      </div>
    </footer>
